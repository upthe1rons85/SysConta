Public Class frmRTPEdoResulCecoN4V2
    Public Mes As Integer
    Public Anio As Integer
    Public Nivel As Integer
    Private Sub frmRTPEdoResulCecoN4V2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'DSEdoResulCecoN4V2.spEdoResulCECOn4V2' Puede moverla o quitarla según sea necesario.
        Me.spEdoResulCECOn4V2TableAdapter.Fill(Me.DSEdoResulCecoN4V2.spEdoResulCECOn4V2, Anio, Mes)
