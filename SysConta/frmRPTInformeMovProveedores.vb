Public Class frmRPTInformeMovProveedores
    ...
    Private Sub frmRPTInformeMovProveedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ''TODO: esta línea de código carga datos en la tabla 'DSMovProveedores.spInformeMovProveedores' Puede moverla o quitarla según sea necesario.
        'Me.spInformeMovProveedoresTableAdapter.Fill(Me.DSMovProveedores.spInformeMovProveedores)
